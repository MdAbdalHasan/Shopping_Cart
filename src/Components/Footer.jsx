...
const Footer = () => {
  return (
    <div>
      <footer className="bg-[#0F172A] text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
                <Link>
                  ...
                  <img
                    src={shortLogo}
                    alt="logo"
                    className=" h-14 block sm:hidden"
                  />
                </Link>
              </div>
            </div>
            ...
            <div className="">
              ...
              <p>
                <a className="text-neutral-600 dark:text-neutral-200">Sell</a>
              </p>
            </div>
        ...
        {/* <!--Copyright section--> */}
        <div className="bg-[#0F172A] p-6 text-center dark:bg-neutral-700">
          <span>© 2023 Copyright:</span>
          <a
            className="font-semibold text-neutral-600 dark:text-neutral-400"
            href="https://www.linkedin.com/in/md-abdal-hasan/"
          >
            @abdal
          </a>
        </div>
